                  ...
                  <div class="x_content">
                    ...
                    <?php $url = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product-nome" name="product_name" required="required" value="<?php echo (substr(DB::table('products')->select('nome')->where('id','=',$id)->get(), 10,-3)); ?>" class="form-control col-md-7 col-xs-12" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="product-valor" name="product_value" required="required" value="<?php echo (substr(DB::table('products')->select('valor')->where('id','=',$id)->get(), 11,-3)); ?>"class="form-control col-md-7 col-xs-12" readonly>
                        </div>
                      </div>
                      <script> 
